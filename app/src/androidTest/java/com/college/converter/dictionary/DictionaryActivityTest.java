...
public class DictionaryActivityTest {
    ...
    public void dictionaryActivityTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.record), withText("An animal of the family Felidae:"),
                        withParent(withParent(withId(R.id.recycle_view_definitions))),
                        isDisplayed()));
        textView.check(matches(withText("An animal of the family Felidae:")));
    }
