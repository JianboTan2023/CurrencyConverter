...
public class DeezerActivityTest {
    ...
    @Test
    public void deezerActivityTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.nameInput),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Beatles"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.artistName), withText("The Beatles"),
