...
import com.college.converter.data.ChatViewModel;
...
public class SunActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.editTextLat.setText(spSearch.getString("latSearch","0"));
        binding.editTextLongitut.setText(spSearch.getString("lngSearch","0"));
        // Set OnClickListener for Search button
        binding.buttonSearch.setOnClickListener(clk -> {
            latitude = binding.editTextLat.getText().toString();
            longitude = binding.editTextLongitut.getText().toString();
        ...
        binding.buttonSave.setOnClickListener(click ->{
            ...
            ChatMessage chatmessage1= new ChatMessage(binding.editTextLat.getText().toString(),
